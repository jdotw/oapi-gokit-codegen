...
import (
	...
	"github.com/jdotw/oapi-gokit-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/jdotw/oapi-gokit-codegen/pkg/gin-middleware"
)
...
```
    import (
        "github.com/jdotw/oapi-gokit-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/jdotw/oapi-gokit-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  - skip-prune
import-mapping:
  ./packageA/spec.yaml: github.com/jdotw/oapi-gokit-codegen/internal/test/externalref/packageA
