...
//go:generate go run github.com/jdotw/oapi-gokit-codegen/cmd/oapi-gokit-codegen --config=types.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/jdotw/oapi-gokit-codegen/cmd/oapi-gokit-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
