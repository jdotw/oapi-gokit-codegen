//go:generate go run github.com/jdotw/oapi-gokit-codegen/cmd/oapi-gokit-codegen --package=api --generate types,chi-server,spec -o petstore.gen.go ../../petstore-expanded.yaml
